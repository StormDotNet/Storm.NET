...
namespace StormDotNet
{
    ...
    using Factories.Func;
    using Factories.Immutable;
    ...
    {
        public static StormErrorFactory Error => ErrorFactories.Default;
        public static StormFuncFactoryFromValuesWithCompare Func => FuncFactories.Default;
        public static StormImmutableFactory Immutable => ImmutableFactories.Default;
