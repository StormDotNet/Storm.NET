...
namespace StormDotNet.Factories.Func
{
    ...
    public class StormFuncFactoryFromStatesWithCompare
    {
        internal StormFuncFactoryFromStatesWithCompare()
        {
        }
            ...
            Func<StormFuncInput<TFirst>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TResult>(first, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TResult>(first, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TResult>(first, second, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TResult>(first, second, func, comparer);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TResult>(first, second, third, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, StormFuncInput<TThird>, StormFuncInput<TFourth>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TResult>(first, second, third, fourth, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TResult>(first, second, third, fourth, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, StormFuncInput<TThird>, StormFuncInput<TFourth>, StormFuncInput<TFifth>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TResult>(first, second, third, fourth, fifth, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TResult>(first, second, third, fourth, fifth, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, StormFuncInput<TThird>, StormFuncInput<TFourth>, StormFuncInput<TFifth>, StormFuncInput<TSixth>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TResult>(first, second, third, fourth, fifth, sixth, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TResult>(first, second, third, fourth, fifth, sixth, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, StormFuncInput<TThird>, StormFuncInput<TFourth>, StormFuncInput<TFifth>, StormFuncInput<TSixth>, StormFuncInput<TSeventh>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TResult>(first, second, third, fourth, fifth, sixth, seventh, func, EqualityComparer<TResult>.Default);
        }
            ...
            IEqualityComparer<TResult> comparer)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TResult>(first, second, third, fourth, fifth, sixth, seventh, func, comparer);
        }
            ...
            Func<StormFuncInput<TFirst>, StormFuncInput<TSecond>, StormFuncInput<TThird>, StormFuncInput<TFourth>, StormFuncInput<TFifth>, StormFuncInput<TSixth>, StormFuncInput<TSeventh>, StormFuncInput<TEighth>, TResult> func)
        {
            ...
            return new StormFuncFromStates<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEighth, TResult>(first, second, third, fourth, fifth, sixth, seventh, eighth, func, EqualityComparer<TResult>.Default);
        }
