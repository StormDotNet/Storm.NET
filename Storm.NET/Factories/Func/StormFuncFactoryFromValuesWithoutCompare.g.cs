...
namespace StormDotNet.Factories.Func
{
    ...
    public class StormFuncFactoryFromValuesWithoutCompare
    {
        internal StormFuncFactoryFromValuesWithoutCompare()
        {
        }
            ...
            Func<TFirst, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TResult>(first, func, null);
        }
            ...
            Func<TFirst, TSecond, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TSecond, TResult>(first, second, func, null);
        }
            ...
            Func<TFirst, TSecond, TThird, TFourth, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TSecond, TThird, TFourth, TResult>(first, second, third, fourth, func, null);
        }
            ...
            Func<TFirst, TSecond, TThird, TFourth, TFifth, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TSecond, TThird, TFourth, TFifth, TResult>(first, second, third, fourth, fifth, func, null);
        }
            ...
            Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TResult>(first, second, third, fourth, fifth, sixth, func, null);
        }
            ...
            Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TResult> func)
        {
            ...
            return new StormFuncFromValues<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TResult>(first, second, third, fourth, fifth, sixth, seventh, func, null);
        }
