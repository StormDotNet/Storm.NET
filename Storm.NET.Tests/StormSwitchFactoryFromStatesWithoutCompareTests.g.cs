...
namespace StormDotNet.Tests
{
    ...
    [TestFixture]
    public class StormSwitchFactoryFromStatesWithoutCompareTests
    {
        [SetUp]
        public void SetUp()
        {
            Sut = new StormSwitchFactoryFromStatesWithoutCompare();
        }

        private StormSwitchFactoryFromStatesWithoutCompare Sut { get; set; }
