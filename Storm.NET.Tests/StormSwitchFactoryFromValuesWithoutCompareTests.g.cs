...
namespace StormDotNet.Tests
{
    ...
    [TestFixture]
    public class StormSwitchFactoryFromValuesWithoutCompareTests
    {
        [SetUp]
        public void SetUp()
        {
            Sut = new StormSwitchFactoryFromValuesWithoutCompare();
        }

        private StormSwitchFactoryFromValuesWithoutCompare Sut { get; set; }
