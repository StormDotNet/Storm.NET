...
namespace StormDotNet.Tests
{
    ...
    [TestFixture]
    public class StormFuncFactoryFromValuesWithoutCompareTests
    {
        [SetUp]
        public void SetUp()
        {
            Sut = new StormFuncFactoryFromValuesWithoutCompare();
        }

        private StormFuncFactoryFromValuesWithoutCompare Sut { get; set; }
